...
(function () {
    ...
    CKEDITOR.config.coreStyles_bold = {element: "strong", overrides: "b", styles: {'font-weight': 'bold'}};
    CKEDITOR.config.coreStyles_italic = {element: "em", overrides: "i", styles: {'font-style': 'italic'}};
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,about,basicstyles,clipboard,resize,button,toolbar,enterkey,entities,floatingspace,wysiwygarea,image,indent,indentlist,fakeobjects,link,list,magicline,maximize,undo,justify';
    ...
    (function () {
        ...
        if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,image,312,,indent-rtl,336,,indent,360,,outdent-rtl,384,,outdent,408,,anchor-rtl,432,,anchor,456,,link,480,,unlink,504,,bulletedlist-rtl,528,,bulletedlist,552,,numberedlist-rtl,576,,numberedlist,600,,maximize,624,,redo-rtl,648,,redo,672,,undo-rtl,696,,undo,720,,justifyblock,744,,justifycenter,768,,justifyleft,792,,justifyright,816,', 'icons_hidpi.png'); else setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,image,312,auto,indent-rtl,336,auto,indent,360,auto,outdent-rtl,384,auto,outdent,408,auto,anchor-rtl,432,auto,anchor,456,auto,link,480,auto,unlink,504,auto,bulletedlist-rtl,528,auto,bulletedlist,552,auto,numberedlist-rtl,576,auto,numberedlist,600,auto,maximize,624,auto,redo-rtl,648,auto,redo,672,auto,undo-rtl,696,auto,undo,720,auto,justifyblock,744,auto,justifycenter,768,auto,justifyleft,792,auto,justifyright,816,auto', 'icons.png');
    })();
